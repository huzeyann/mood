...
@torch.inference_mode()
def extract_clip_embedding_tensor(tensor_image, ip_model, resize=True):
    ...
    clip_image_embeds = ip_model.image_encoder(tensor_image, output_hidden_states=True, interpolate_pos_encoding=True).hidden_states[-2]
    clip_image_embeds = clip_image_embeds.float()
    return clip_image_embeds
